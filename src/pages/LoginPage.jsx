  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 flex flex-col items-center justify-center px-4 py-8">
      ...
      <div className="text-center mb-6">
        <div className="w-14 h-14 bg-orange-500 rounded-2xl flex items-center justify-center mx-auto mb-3 text-2xl">
          ⚡
        </div>
      ...
      <SignIn
        ...
        appearance={{
          elements: {
            ...
            socialButtonsBlockButton: "border border-gray-200 hover:bg-gray-50 rounded-xl transition",
            formButtonPrimary: "bg-orange-500 hover:bg-orange-600 rounded-xl transition",
